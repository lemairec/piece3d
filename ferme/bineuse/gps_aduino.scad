...
module gps(){
    difference(){
        union(){
            ...
            rotate([0,0,90])translate([boitier_lg/2, 20, 0]) fixation_u();
            rotate([0,0,90])translate([boitier_lg/2, 0, 0]) fixation_u();
            rotate([0,0,90])translate([boitier_lg/2, -20, 0]) fixation_u();
        ...
        rotate([0,0,90])translate([boitier_lg/2, 20, 0]) fixation_d();
        rotate([0,0,90])translate([boitier_lg/2, 0, 0]) fixation_d();
        rotate([0,0,90])translate([boitier_lg/2, -20, 0]) fixation_d();
...
gps();
%translate([0,0,10]) cube([55, 100,2], center = true);