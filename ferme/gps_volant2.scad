...
module support_moteur3(x_vis = 100){
    ...
    difference(){
        ...
        translate([x_moteur,0,2]) moteur2();
    }
    ...
    if(mode2==1){
        ...
        color("blue")translate([-x_vis/2,0,25]) rotate([0,180,90+0]) support_moteur3_bis();
    }
}
...
if(mode==0){
    ...
    translate([0,120,-25])rotate([-180,0,180]) support_moteur3();
